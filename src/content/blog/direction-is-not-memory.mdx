...
[Fabric](https://github.com/lutefd/fabric/) is the local-first protocol I built around this idea: persistent repository direction and causal provenance across agent threads, worktrees, and tools.
